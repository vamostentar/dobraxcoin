...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-7ORU6ZDL.js");
  const signature_ = (() => {
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-S2AD4JAO.js").then((module) => module.WebSocket);
...
var InvalidAbiItemError2 = class extends BaseError3 {
...
var UnknownTypeError2 = class extends BaseError3 {
  constructor({ type }) {
    super("Unknown type.", {
      metaMessages: [
...
var InvalidAbiParametersError2 = class extends BaseError3 {
  constructor({ params }) {
...
var InvalidParameterError2 = class extends BaseError3 {
  constructor({ param }) {
...
var SolidityProtectedKeywordError2 = class extends BaseError3 {
...
var InvalidModifierError2 = class extends BaseError3 {
...
var InvalidFunctionModifierError2 = class extends BaseError3 {
  constructor({ param, type, modifier }) {
    super("Invalid ABI parameter.", {
      details: param,
      metaMessages: [
...
var InvalidAbiTypeParameterError2 = class extends BaseError3 {
...
var InvalidSignatureError2 = class extends BaseError3 {
...
var UnknownSignatureError2 = class extends BaseError3 {
  constructor({ signature }) {
...
var InvalidStructSignatureError2 = class extends BaseError3 {
  constructor({ signature }) {
...
var CircularReferenceError2 = class extends BaseError3 {
  constructor({ type }) {
...
var InvalidParenthesisError2 = class extends BaseError3 {
...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value = fromBytes2(cursor.readBytes(Number.parseInt(size5, 10), 32));
  return [value, 32];
}
...
function fromBytes4(signature) {
  return fromHex5(fromBytes2(signature));
}
...
export {
  ...
  hexToNumber,
  hexToRlp,
  parseSignature2 as hexToSignature,
  hexToString,
  http,
  isAddress,
  isAddressEqual,
  ...
  parseEventLogs,
  parseGwei,
  parseSignature2 as parseSignature,
  parseTransaction,
  parseUnits,
  prepareEncodeFunctionData,
